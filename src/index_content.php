...
<section class="bg-image sec1"
    ...
    <div class="container text-white text-center"
        ...
        <p class="fs-4 fst-italic">Ce site est là pour vous aider à affiner vos recherches,  vous renseigner et  vous
            mettre
            en relation avec
            un réseau en IdL</p>
...
<section class="container-fluid bg-image sec2" id="sec2"
    style="background-image: url(assets/images/bg2.jpg); background-size: cover; background-position: center;">
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2">
            ...
            <div class="col">
                <div class="card justify-content-center align-items-center u-dark">
                    <div class="card-header my-3">
                        <div class="icon">
                            <img src="assets/images/map.png" style="height: 70px; width: 70px;">
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <a href="carte.php" class="btn">
                            <img src="assets/images/arrow.png" style="width: 60px;">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card justify-content-center align-items-center u-light">
                    <div class="card-header my-3">
                        <div class="icon">
                            <img src="assets/images/search.png" style="height: 70px; width: 70px;">
                        </div>
                    </div>
                    <div class="card-body text-white" style="text-align:center">
                        <h4 class="card-title">RECHERCHE</h4>
                        <p class="card-text">Trouve-moi mon coup de coeur </p>
                    </div>
                    <div class="card-footer">
            ...
            <div class="col" style="<?php if (!isset($_SESSION['username']) || $_SESSION['username'] != "admin") {
                ...
                <div class="card justify-content-center align-items-center u-light">
                    <div class="card-header my-3">
                        <div class="icon">
                            <img src="assets/images/plus.png" style="height: 70px; width: 70px;">
                        </div>
                    </div>
                    <div class="card-body text-white" style="text-align:center">
            ...
            <div class="col">
                <div class="card justify-content-center align-items-center u-dark">
                    <div class="card-header my-3">
                        <div class="icon">
                            <img src="assets/images/network.png" style="height: 70px; width: 70px;">
                        </div>
                    </div>
                    <div class="card-body text-white" style="text-align:center">
...
<section class="bg-image sec3"
    ...
    <div class="container text-white text-center"
        style="display: flex; align-items: center; justify-content: center; height: 100%; flex-direction: column;">
        <p class="fs-1 lh-base">Comment CartoStages IDaL fonctionne ?
        </p>
        <p class="fs-4"> Choisissez votre mode de recherche favori, consultez les offres qui vous
            correspondent, postulez !
            Accédez aux précdents mémoires et rapports de stages, et  des informations utiles sur les anciens stages
            réaliss.
