            ...
            <div class="container">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <a href="index.php"
                        ...
                        <img src="assets/images/logo.svg" alt="Logo" style="width:134px; height:85px;">
                    </a>
                        ...
                        <div class="logged">
                            ...
                            <div class="dropdown text-end d-inline-block">
                                <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle"
                                    ...
                                    <img src="assets/images/network.png" alt="avatar" width="40" height="40"
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center my-3">
                        <a href="index.php" class="logo"><img src="assets/images/logo_white.svg" alt="Logo"
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-center text-white">
                        <p class="copyright">
                            ...
                            CartoStages IDéaL a été réalisé
...
<script>
        ...
        $('#envoyer_nouvelle').on('click', function (e) {
            ...
            $.ajax({
                ...
                error: function (error) {
                    ...
                    console.log(error);
                    $('#message').html(error);
                    alert("Votre demande a chou, veuillez ressayer plus tard.");
                }
            });
        });
    });
    ...
    $(document).on("click", "#register_submit", function (e) {
        ...
        if (username == "") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === "success") {
                        alert("Inscription réussie et vous serez connect automatiquement !");
                        location.reload();
                    } else {
                        alert("Erreur : " + response);
                    }
    ...
    var address = "621 avenue Centrale, 38400 Saint-Martin-d'Hres, France";
    var url =
