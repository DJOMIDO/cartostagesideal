			...
			<div class="col-12">
				...
				<div class="card p-3 py-4 text-center">
					...
					<div class="row g-3 mt-2">
						...
						<div class="col-md-6">
							<input type="text" id="recherche" name="recherche" class="form-control form-control-lg"
								placeholder="Recherche...">
						</div>

						<div class="col-md-3">
							<button id="search" class="btn btn-secondary btn-lg btn-block" data-bs-toggle="collapse"
								data-bs-target="#here" role="button" aria-expanded="false" aria-controls="here"><i
